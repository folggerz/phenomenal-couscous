	...
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			while (convertAgain)
			{
				...
				do.. while (conversion ==) // Failure to include 'while' when initializing do..while loop.
				{
				...
				while (true)
				{
					try
					{
						...
						else if (conversion == "2")
						{
							...
							double temp = double.Parse(Console.WriteLine(int 0 i++)); // Console.WriteLine needs to have an int placed inside the parentheses.
							double convertedTemp = (temp * 9 / 5) + 32;
							Console.WriteLine($"{temp} is equivalent to {convertedTemp}") // Missing second instance of quotes with parenthesis.
						}
					}
				...
				{ 
						...
						if ((conversion!= "2"))
					{
						...
						double temp = Convert.ToDouble(Console.ReadLine());
						double convertedTemp = (temp * 9 / 5) + 32;
						Console.WriteLine($"{temp} is equivalent to {convertedTemp}
					}
					else if (conversion == "2")
					{
						Console.WriteLine("Please enter a temperature in celsius");
						double temp = double.Parse(Console.WriteLine(int 0 i++));
						double convertedTemp = (temp != 33);
